                ...
                <div id="dashboard-main-center">
                    ...
                    <div class="box-white">
                        <div class="box-white-header-clean">
                            <div class="title small"><?php echo $this->lang('dashboard_groups_title_your'); ?></div>
                            
                            <div class="some-right"><div><span class="blue">+</span> <span class="link link-blue bold"><a href="<?php echo $K->SITE_URL?>groups/create" rel="phantom" target="dashboard-main-area-right"><?php echo $this->lang('dashboard_groups_txt_creategroup')?></a></span></div></div>
                        ...
                        <div class="box-white-body">
                            ...
                            <p class="centered grey"><?php echo $this->lang('dashboard_groups_txt_nogroups'); ?></p>
                            ...
                            <div id="space_more" class="centered">
                                ...
                                <input type="hidden" id="activities_place" name="activities_place" value="groups" />
