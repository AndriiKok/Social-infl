                ...
                <div id="dashboard-main-center">
                    ...
                    <div class="box-white">
                        <div class="box-white-header-clean">
                            <div class="ico"><img src="<?php echo getImageTheme('i-m-albums.png');?>" alt=""></div>
                            <div class="title withico"><?php echo $this->lang('dashboard_albums_title'); ?></div>
                            
                            <div class="some-right withico"><div><span class="blue">+</span> <span class="link link-blue bold"><a href="<?php echo $K->SITE_URL?>albums/create" rel="phantom" target="dashboard-main-area-right"><?php echo $this->lang('dashboard_albums_txt_create_album')?></a></span></div></div>
                        ...
                        <div class="box-white-body">
                            ...
                            <p class="centered grey"><?php echo $this->lang('dashboard_albums_txt_noalbum'); ?></p>
                                
                            <?php } else {?>
                            
                            <div id="list-items" class="thealbums">
