                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            ...
                            <div class="title"><?php echo $this->lang('admin_articles_title')?></div>
                            <div class="clear"></div>
                        </div>
...
<script>
    ...
    var msg_delete_article = stripslashes('<?php echo $this->designer->boxConfirm($this->lang('admin_articles_title_delete'), $this->lang('admin_articles_msg_delete'), $this->lang('admin_alert_text_confirm'), $this->lang('admin_alert_text_cancel'))?>');
