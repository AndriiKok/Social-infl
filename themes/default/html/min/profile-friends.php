                    ...
                    <div id="profile-content-area">
                        ...
                        <div class="box-white mrg30B">
                            ...
                            <div class="box-white-header">
                                <div class="title small"><?php echo $this->lang('profile_friends_title')?></div>
                                <div class="clear"></div>
                            </div>
                            
                            <div class="box-white-body">
                            
                                <?php if (empty($D->html_friends)) { ?>
                                
                                <div class="centered mrg20T mrg20B grey"><?php echo $this->lang('profile_friends_nohave', array('#THEUSER#'=>$D->the_name_user))?></div>
                                
                                <?php } else { ?>
                                
                                <?php echo $D->html_friends ?>
