                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            <div class="ico"><img src="<?php echo getImageTheme('ico-admin-groups.png')?>"></div>
                            <div class="title"><?php echo $this->lang('admin_groups_title')?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <?php } else { ?>                       
                                ...
                                <div class="myTable table-list-2col">
                                ...
                                <p class="grey2 mrg20T"><span id="num_items" class="bold"><?php echo $D->numusers?></span> <?php echo($D->numusers==1 ? $this->lang('admin_txt_item') : $this->lang('admin_txt_items'))?></p>
...
<script>
    ...
    var msg_delete_group = stripslashes('<?php echo $this->designer->boxConfirm($this->lang('admin_groups_title_delete'), $this->lang('admin_groups_msg_delete'), $this->lang('admin_alert_text_confirm'), $this->lang('admin_alert_text_cancel'))?>');
