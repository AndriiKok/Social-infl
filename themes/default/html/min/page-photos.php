                    ...
                    <div id="profile-content-area">
                        ...
                        <div class="box-white mrg30B">
                            ...
                            <div class="box-white-header">
                                <div class="title small"><?php echo $this->lang('profile_page_photos_title')?></div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="box-white-body">
                                ...
                                <div class="centered mrg20T mrg20B grey"><?php echo $this->lang('profile_page_photos_nohave', array('#THEPAGE#'=>$D->the_title))?></div>
