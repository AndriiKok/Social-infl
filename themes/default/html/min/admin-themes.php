                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            <div class="ico"><img src="<?php echo getImageTheme('ico-admin-themes.png')?>"></div>
                            <div class="title"><?php echo $this->lang('admin_themes_title')?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_themes_block_theme')?></div>

                                <form id="form1" name="form1" method="post" action="">
                                <div class="form-block">
                                    <label for="thetheme"><?php echo $this->lang('admin_themes_block_theme_foryour')?></label>
                                    <select name="thetheme" id="thetheme" class="form-control">
                                        <?php foreach($D->list_themes as $k=>$v) {?>

                                            <option value="<?php echo($k)?>" <?php echo($k==$D->theme_default?'selected="selected"':'')?>><?php echo($v)?></option>
                                        <?php } ?>
                                    </select>
                                </div>
