                ...
                <div id="dashboard-main-center">
                    ...
                    <div class="box-activity centered">
                        ...
                        <div style="padding:50px 10px 40px;">
                            ...
                            <div style="font-size:15px;"><?php echo $this->lang('dashboard_groups_feed_nopost')?></div>

                        </div>

                        <div style="margin-bottom:50px;">

                            <span><a href="<?php echo $K->SITE_URL?>groups/search" rel="phantom" target="dashboard-main-area-right"><img src="<?php echo getImageTheme('search-groups.png')?>"></a></span>

                            <div class="clear"></div>

                            <span class="link link-blue"><a href="<?php echo $K->SITE_URL?>groups/search" rel="phantom" target="dashboard-main-area-right"><?php echo $this->lang('dashboard_groups_feed_searchpages')?></a></span>
