<div class="one-item-library" id="itemlibrary-<?php echo $D->article->code; ?>">

    <a href="<?php echo $K->SITE_URL; ?>article/<?php echo $D->article->code; ?>" <?php echo($D->_IS_LOGGED ? 'rel="phantom" target="dashboard-main-area-right"' : '') ?>>
