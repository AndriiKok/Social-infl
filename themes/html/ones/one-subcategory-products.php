    ...
    <div id="areaedit-<?php echo $D->one->idcategory?>" class="hide edit_item">
        ...
        <div class="space-in-admin">
            ...
            <div class="form-block">
                ...
                <label for="namecategory<?php echo $D->one->idcategory?>"><?php echo $this->lang('admin_products_subcategories_text_subcategory')?></label>
...
$('#delcat-<?php echo $D->one->idcategory?>').click(function(){
    closeEmerged();
    _confirm(msg_delete_subcategory_product, nothign, deleteSubCategoryProduct, <?php echo $D->one->idcategory?>);
});
...
$('#bupdate<?php echo $D->one->idcategory?>').click(function(e){
    e.preventDefault();
    updateSubCategoryProduct(<?php echo $D->one->idcategory?>);
});
