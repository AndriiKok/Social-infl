    ...
    <div id="areaedit-<?php echo $D->one->idcategory?>" class="hide edit_item">
        ...
        <div class="space-in-admin">
            ...
            <div class="form-block">
                ...
                <label for="namecategory<?php echo $D->one->idcategory?>"><?php echo $this->lang('admin_articles_subcategories_text_subcategory')?></label>
            ...
            <div class="mrg5T mrg10B">
                ...
                <span><input type="submit" name="bupdate<?php echo $D->one->idcategory?>" id="bupdate<?php echo $D->one->idcategory?>" value="<?php echo $this->lang('admin_articles_categories_txt_update'); ?>" class="my-btn my-btn-small"/></span> <span id="bcancel<?php echo $D->one->idcategory?>" class="grey2 hand" style="margin-left:10px;"><?php echo $this->lang('admin_articles_categories_txt_cancel'); ?></span>
...
$('#delcat-<?php echo $D->one->idcategory?>').click(function(){
    closeEmerged();
    _confirm(msg_delete_subcategory_article, nothign, deleteSubCategoryArticle, <?php echo $D->one->idcategory?>);
});
...
$('#bupdate<?php echo $D->one->idcategory?>').click(function(e){
    e.preventDefault();
    updateSubCategoryArticle(<?php echo $D->one->idcategory?>);
});
