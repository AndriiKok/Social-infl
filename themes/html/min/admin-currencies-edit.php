                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            ...
                            <div class="title"><?php echo $this->lang('admin_currencies_edit_title')?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_currencies_edit_title_edit')?></div>

                                <form id="form1" name="form1" method="post" action="">

                                <div class="form-block">
                                    <label for="namecurrency"><?php echo $this->lang('admin_currencies_add_name')?></label>
                                    <input name="namecurrency" type="text" value="<?php echo $D->name; ?>" id="namecurrency" placeholder="<?php echo $this->lang('admin_currencies_add_name')?>" class="form-control"/>
                                </div>

                                <div class="form-block">
                                    <label for="codecurrency"><?php echo $this->lang('admin_currencies_add_code')?></label>
                                    <input name="codecurrency" type="text" value="<?php echo $D->code_iso; ?>" id="codecurrency" placeholder="<?php echo $this->lang('admin_currencies_add_code')?>" class="form-control"/>
                                </div>
                                
                                <div class="form-block">
                                    <label for="symbolcurrency"><?php echo $this->lang('admin_currencies_add_symbol')?></label>
                                    <input name="symbolcurrency" type="text" value="<?php echo $D->symbol; ?>" id="symbolcurrency" placeholder="<?php echo $this->lang('admin_currencies_add_symbol')?>" class="form-control"/>
                                </div>

                                <div id="msgerror1" class="alert alert-red hide"></div>
                                <div id="msgok1" class="alert alert-green hide"></div>
                                <div><input type="submit" name="bsave1" id="bsave1" value="<?php echo $this->lang('admin_currencies_edit_bupdate')?>" class="my-btn my-btn-blue"/></div>
...
<script>
    ...
    var idc = <?php echo $D->idcurrency; ?>;
    $('#bsave1').click(function(e){
        e.preventDefault();
        updateCurrency('#msgerror1', '#msgok1', '#bsave1');
    });
