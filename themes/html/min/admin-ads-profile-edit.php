                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            ...
                            <div class="title"><?php echo $this->lang('admin_ads_profile_edit_title')?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_ads_profile_edit_title_edit')?></div>
                                
                                <div class="form-block">
                                    <label for="type_ads"><?php echo $this->lang('admin_ads_profile_edit_type_ads')?>: <span style="font-weight:normal;"><?php echo $D->text_type; ?></span></label>
                                </div>
                                ...
                                <div id="space_ads_image">
                                    ...
                                    <div class="form-block">
                                        ...
                                        <input name="nameads" type="text" id="nameads" value="<?php echo $D->name?>" placeholder="<?php echo $this->lang('admin_ads_profile_add_name')?>" class="form-control"/>
                                    </div>
                                    ...
                                    <div class="form-block">
                                        ...
                                        <div id="imageupload" class="space_upload">
                                            ...
                                            <div id="imagepreview"><div class="msgupload"><?php echo $this->lang('profile_articles_publish_txt_upload_image')?></div></div>
                                            <?php } else {?>
                                    ...
                                    <div class="form-block">
                                        ...
                                        <input name="urlads" type="text" id="urlads" value="<?php echo $D->theurl?>" placeholder="<?php echo $this->lang('admin_ads_profile_add_url')?>" class="form-control"/>
                                    </div>
                                    
                                    <div class="form-block">
                                        <label for="target"><?php echo $this->lang('admin_ads_profile_add_load')?>:</label>
                                        <select name="target" id="target" class="form-control">
                                            <option value="0" <?php echo($D->target == 0 ? 'selected' : '')?>><?php echo $this->lang('admin_ads_profile_add_load_same')?></option>
                                            <option value="1" <?php echo($D->target == 1 ? 'selected' : '')?>><?php echo $this->lang('admin_ads_profile_add_load_blank')?></option>
                                        </select>
                                    </div>
                                    
                                    <div class="form-block">
                                        <label for="status"><?php echo $this->lang('admin_ads_profile_edit_status')?>:</label>
                                        <select name="status" id="status" class="form-control">
                                            <option value="0" <?php echo($D->status == 0 ? 'selected' : '')?>><?php echo $this->lang('admin_ads_profile_edit_status_disabled')?></option>
                                            <option value="1" <?php echo($D->status == 1 ? 'selected' : '')?>><?php echo $this->lang('admin_ads_profile_edit_status_enabled')?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div><input type="submit" name="bsave1" id="bsave1" value="<?php echo $this->lang('admin_ads_profile_edit_bupdate')?>" class="my-btn my-btn-blue"/></div>
                                ...
                                <div id="space_ads_html">
                                    ...
                                    <div><input type="submit" name="bsave2" id="bsave2" value="<?php echo $this->lang('admin_ads_profile_edit_bupdate')?>" class="my-btn my-btn-blue"/></div>
...
<script>
    ...
    var txt_error_status = stripslashes('<?php echo strJS($this->lang('admin_ads_profile_edit_error_status'))?>');
