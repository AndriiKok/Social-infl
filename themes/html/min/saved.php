               <script>_ID_MENU_LEFT = '<?php echo(isset($D->id_menu) ? $D->id_menu : '')?>';</script>
                ...
                <div id="dashboard-main-center">
                    ...
                    <div class="box-white-title" style="margin-bottom:10px;">
                        <div class="inside-space">
                            <div class="ico"><img src="<?php echo getImageTheme('i-m-saved.png'); ?>"></div>
                            <div class="title"><?php echo $this->lang('dashboard_saved_title');?></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                
                    <div id="the-posts-init"><div style="text-align:center;"><img src="<?php echo getImageTheme('preload.gif');?>"></div></div>
                ...
                <script type="text/javascript">
                    $(function() {
                        setTimeout(function(){ loadSavedPostInit(); }, 1);
                    });
                </script>
