                ...
                <div id="dashboard-main-center">
                    ...
                    <div class="box-white">
                        <div class="box-white-header-clean">
                            <div class="ico"><img src="<?php echo getImageTheme('i-m-myproducts.png');?>" alt=""></div>
                            <div class="title withico"><?php echo $this->lang('dashboard_products_title'); ?></div>
                            
                            <div class="some-right withico"><div><span class="blue">+</span> <span class="link link-blue bold"><a href="<?php echo $K->SITE_URL?>products/create" rel="phantom" target="dashboard-main-area-right"><?php echo $this->lang('dashboard_products_sell')?></a></span></div></div>
                        ...
                        <div class="box-white-body">
                            ...
                            <p class="centered grey"><?php echo $this->lang('dashboard_products_empty'); ?></p>
                                
                            <?php } else {?>
                            
                            <div id="list-items" class="theproducts">
                            ...
                            <div id="space_more" class="centered">
                                ...
                                <input type="hidden" id="activities_place" name="activities_place" value="myproducts" />
