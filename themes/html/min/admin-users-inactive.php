                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            <div class="ico"><img src="<?php echo getImageTheme('ico-admin-user-inactive.png')?>"></div>
                            <div class="title"><?php echo $this->lang('admin_users_inactive_title')?></div>
                            <div class="clear"></div>
                        </div>
...
<script>
    ...
    var msg_delete_user = stripslashes('<?php echo $this->designer->boxConfirm($this->lang('admin_users_title_delete'), $this->lang('admin_users_msg_delete'), $this->lang('admin_alert_text_confirm'), $this->lang('admin_alert_text_cancel'))?>');
