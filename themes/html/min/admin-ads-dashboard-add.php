                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            ...
                            <div class="title"><?php echo $this->lang('admin_ads_dashboard_add_title')?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_ads_dashboard_add_title_new')?></div>
                                
                                <div class="form-block">
                                    <label for="type_ads"><?php echo $this->lang('admin_ads_dashboard_add_type_ads')?>:</label>
                                    <select name="type_ads" id="type_ads" class="form-control">
                                        <option value="0"><?php echo $this->lang('admin_ads_dashboard_add_choose_type_ads')?></option>
                                        <option value="1"><?php echo $this->lang('admin_ads_dashboard_add_type_ads_image')?></option>
                                        <option value="2"><?php echo $this->lang('admin_ads_dashboard_add_type_ads_html')?></option>
                                    </select>
                                </div>
                                ...
                                <div id="space_ads_image" style="display:none;">
                                    ...
                                    <div class="form-block">
                                        ...
                                        <input name="nameads" type="text" id="nameads" placeholder="<?php echo $this->lang('admin_ads_dashboard_add_name')?>" class="form-control"/>
                                    </div>
                                    
                                    <div class="form-block">
                                        <label for="imageupload"><?php echo $this->lang('admin_ads_dashboard_add_banner')?>:</label>
                                        <div id="imageupload" class="space_upload">
                                            <div id="imagepreview"><div class="msgupload"><?php echo $this->lang('admin_ads_dashboard_add_banner_txt_upload')?></div></div>
                                    ...
                                    <div class="form-block">
                                        ...
                                        <input name="urlads" type="text" id="urlads" placeholder="<?php echo $this->lang('admin_ads_dashboard_add_url')?>" class="form-control"/>
                                    </div>
                                    
                                    <div class="form-block">
                                        <label for="target"><?php echo $this->lang('admin_ads_dashboard_add_load')?>:</label>
                                        <select name="target" id="target" class="form-control">
                                            <option value="0"><?php echo $this->lang('admin_ads_dashboard_add_load_same')?></option>
                                            <option value="1"><?php echo $this->lang('admin_ads_dashboard_add_load_blank')?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div><input type="submit" name="bsave1" id="bsave1" value="<?php echo $this->lang('admin_ads_dashboard_add_bsave')?>" class="my-btn my-btn-blue"/></div>
...
<script>
    ...
    $('#bsave1').click(function(e){
        e.preventDefault();
        createAds('#msgerror1', '#msgok1', '#bsave1', 1);
    });
    ...
    $('#bsave2').click(function(e){
        e.preventDefault();
        createAdsHTML('#msgerror2', '#msgok2', '#bsave2', 1);
    });
