...
<script>
    ...
    var msg_delete_page = stripslashes('<?php echo $this->designer->boxConfirm($this->lang('admin_pages_title_delete'), $this->lang('admin_pages_msg_delete'), $this->lang('admin_alert_text_confirm'), $this->lang('admin_alert_text_cancel'))?>');
