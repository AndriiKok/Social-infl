                ...
                <div id="admin-main-area">
                    ...
                    <div class="box-white">
                        ...
                        <div class="box-white-header">
                            ...
                            <div class="title"><?php echo $this->lang('admin_static_pages_edit_title')?>: <?php echo $D->title?></div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_static_pages_edit_title_update')?></div>

                                <form id="form1" name="form1" method="post" action="">

                                <div class="form-block">
                                    <label for="urlstatic"><?php echo $this->lang('admin_static_pages_add_url')?></label>
                                    <input name="urlstatic" type="text" id="urlstatic" placeholder="<?php echo $this->lang('admin_static_pages_add_url')?>" class="form-control" value="<?php echo $D->url?>"/>
                                </div>

                                <div class="form-block">
                                    <label for="titlestatic"><?php echo $this->lang('admin_static_pages_add_thetitle')?></label>
                                    <input name="titlestatic" type="text" id="titlestatic" placeholder="<?php echo $this->lang('admin_static_pages_add_thetitle')?>" class="form-control" value="<?php echo $D->title?>"/>
                                </div>
                                ...
                                <div class="form-block">
                                    ...
                                    <script>$('#htmlstatic').val(stripslashes('<?php echo strJS($D->html)?>'));</script>
                                </div>
                                ...
                                <div class="form-block">
                                    ...
                                    <select name="infootstatic" id="infootstatic" class="form-control">
                                        <option value="0" <?php echo($D->infoot == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_static_pages_add_infoot_no')?></option>
                                        <option value="1" <?php echo($D->infoot == 1 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_static_pages_add_infoot_yes')?></option>
                                    </select>
                                </div>
...
<script>
    ...
    var id_staticpage = <?php echo $D->idstatic?>;

    $('#bsave1').click(function(e){
        e.preventDefault();
        updateStaticPage('#msgerror1', '#msgok1', '#bsave1');
    });
